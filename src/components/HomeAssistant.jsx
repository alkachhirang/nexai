...
import Assistantimg from '../assets/images/png/assistant-skull-img.webp';
            ...
            <div className="container lg:max-w-[1124px] lg:px-3 px-5 mx-auto">
                <div className='flex flex-row flex-wrap items-center xl:justify-between'>
                    <div className='xl:w-[55%] w-full' data-aos="fade-right">
                        ...
                        <p className='font-normal text-[14px] sm:text-[16px] leading-[25.6px] text-[#fff] xl:text-start text-center '>Nexai is an advanced AI-powered home assistant that brings the future to your fingertips. With its ability to engage in natural, fluent conversations in over 15 languages,</p>
                        <p className='font-normal text-[14px] sm:text-[16px] leading-[25.6px] text-[#fff] xl:text-start text-center'>Nexai offers an incredibly futuristic experience. It can take the initiative to ask about your day, schedule meetings, provide timely reminders</p>
                        <p className='font-normal text-[14px] sm:text-[16px] leading-[25.6px] text-[#fff] mb-[10px] sm:mb-[20px] xl:mb-[40px] xl:text-start text-center'>assist with cooking by suggesting ingredients, track your fitness and nutrition goals, and even handle bill payments.</p>

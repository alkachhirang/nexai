...
import Unique1 from '../assets/images/web.p/unique-img1.webp';
import Unique2 from '../assets/images/web.p/unique-img2.webp';
import Unique3 from '../assets/images/web.p/unique-img3.webp';
import Unique4 from '../assets/images/web.p/unique-img4.webp';
    ...
    return (
        <div id='Features' className='md:pt-[80px] sm:pt-[50px] pt-[40px] pb-[50px] sm:pb-[121px] relative'>
            ...
            <div className='absolute left-0 right-0 bottom-0 top-0 flex justify-center items-center'>
                <img src={Bgimg} alt="Bgimg" className='w-full max-w-[950px] mix-blend-lighten translate-y-[-7%]  ' />
            </div>
            <div className='container lg:max-w-[1124px] lg:px-3 px-5 mx-auto'>
                <div className='flex flex-col justify-center items-center pb-[66px]' data-aos="fade-down">
                    ...
                    <p className='max-w-[517px] text-normal text-[#FFFFFF] text-[14px] sm:text-[16px] leading-[25.6px] text-center opacity-70'>ability to engage in natural, fluent conversations in over 15 languages,</p>
                </div>
                <div className='h-[770px] overflow-y-scroll hidden_scrollbar'>
                    <div className='flex-row flex flex-wrap justify-center lg:justify-between'>
                        <div className='lg:w-[49%] md:w-[70%] w-full'>
                            <div className='rounded-[16px] bg-[#ffffff33] border-[1px] border-[#FCFCFC66] border-solid lg:max-w-[364px] cursor-pointer lg:mb-[180px] mb-[50px] relative z-[1] hover:scale-90 transition-all duration-300 ease-linear'>
                            ...
                            <div className='rounded-[16px] bg-[#ffffff33]  border-[1px] border-[#FCFCFC66] border-solid lg:max-w-[364px] cursor-pointer mb-[50px] relative z-[1] hover:scale-90 transition-all duration-300 ease-linear'>
                                <img src={Unique3} alt="Unique3" className='rounded-tr-[16px] rounded-tl-[16px] lg:max-w-[364px] w-full' />
                                <h3 className='font-semibold text-[20px] text-[#fff] leading-[32px] lg:max-w-[337px] pt-[20px] pb-[30px] pr-[36px] pl-[24px]'>Autonomous and Natural Language Communication</h3>
                            </div>
                        </div>
                        <div className='lg:w-[49%] md:w-[70%] w-full flex flex-col lg:items-end lg:translate-y-[27%]'>
                            <div className='rounded-[16px] border-[1px] bg-[#ffffff33]  border-[#FCFCFC66] border-solid lg:max-w-[364px] w-full cursor-pointer lg:mb-[180px] mb-[50px] hover:scale-90 transition-all duration-300 ease-linear'>
                            ...
                            <div className='rounded-[16px] bg-[#ffffff33]  border-[1px] border-[#FCFCFC66] border-solid lg:max-w-[364px] w-full cursor-pointer hover:scale-90 transition-all duration-300 ease-linear'>

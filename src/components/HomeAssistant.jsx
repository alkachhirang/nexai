    ...
    return (
        <div id='About' className='pt-[37px] md:pt-[45px] lg:pt-[75px] lg:pb-[130px] overflow-hidden relative hidden_scrollbar'>
            ...
            <div className="container lg:max-w-[1124px] lg:px-3 px-5 mx-auto">
                <div className='flex xl:flex-row flex-col-reverse flex-wrap items-center xl:justify-between'>
                    <div className='xl:w-[55%] w-full pt-[30px] xl:pt-0' data-aos="fade-right">
                    ...
                    <div className='xl:w-[40%] flex w-full' data-aos="fade-left">
